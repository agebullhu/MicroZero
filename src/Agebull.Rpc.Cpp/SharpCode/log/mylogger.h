...
#define log_msg1(msg,arg) \
	{\
		char _msg_[4096];\
		sprintf_s(_msg_,msg,arg);\
		log_acl_msg(_msg_);\
	}
#define log_msg2(msg,arg1,arg2) \
	{\
		char _msg_[4096];\
		sprintf_s(_msg_,msg,arg1 , arg2);\
		log_acl_msg(_msg_);\
	}
#define log_msg3(msg,arg1,arg2,arg3) \
	{\
		char _msg_[4096];\
		sprintf_s(_msg_,msg,arg1 , arg2 , arg3);\
		log_acl_msg(_msg_);\
	}
#define log_msg4(msg,arg1,arg2,arg3,arg4) \
	{\
		char _msg_[4096];\
		sprintf_s(_msg_,msg,arg1 , arg2 , arg3 , arg4);\
		log_acl_msg(_msg_);\
	}
#define log_msg5(msg,arg1,arg2,arg3,arg4,arg5) \
	{\
		char _msg_[4096];\
		sprintf_s(_msg_,msg,arg1 , arg2 , arg3 , arg4 , arg5);\
		log_acl_msg(_msg_);\
	}
#define log_msg6(msg,arg1,arg2,arg3,arg4,arg5,arg6) \
	{\
		char _msg_[4096];\
		sprintf_s(_msg_,msg,arg1 , arg2 , arg3 , arg4 , arg5 , arg6);\
		log_acl_msg(_msg_);\
	}
#define log_msg7(msg,arg1,arg2,arg3,arg4,arg5,arg6,arg7) \
	{\
		char _msg_[4096];\
		sprintf_s(_msg_,msg,arg1 , arg2 , arg3 , arg4 , arg5 , arg6 , arg7);\
		log_acl_msg(_msg_);\
	}
