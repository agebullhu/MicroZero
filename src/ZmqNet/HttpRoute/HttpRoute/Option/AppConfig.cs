...
#pragma warning restore CS0649
        ...
        {
            Option.Security.CheckApis = new Dictionary<string, ApiItem>(StringComparer.OrdinalIgnoreCase);
            foreach (var apiItem in Option.Security.checkApis)
                Option.Security.CheckApis.Add(apiItem.Key, apiItem.Value);
