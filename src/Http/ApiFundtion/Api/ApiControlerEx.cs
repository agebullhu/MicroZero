...
namespace Agebull.MicroZero.ZeroApis
{
    ...
    /// ApiController扩展
    /// </summary>
    public abstract class ApiControlerEx : ApiControllerBase
    {
        #region 状态
        ...
        ///     初始化参数字典
        /// </summary>
        protected Dictionary<string, string> InitArguments()
        {
            if (_arguments != null)
                return _arguments;
            ...
            if(ApiCallItem != null)
            {
                ReadArgument(ApiCallItem.Arguments);
                ReadArgument(ApiCallItem.HttpContent);
            }
        ...
        private void ReadArgument(Dictionary<string, string> dic)
        {
            try
            {
