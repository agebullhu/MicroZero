...
namespace Agebull.MicroZero.ZeroApis
{
    ...
    public class ApiCaller
    {
        ...
        public interface IHandler
        {
            ...
            /// <returns></returns>
            void Prepare(ApiCaller item);

            /// <summary>
            ///     结束处理
            /// </summary>
            /// <param name="item"></param>
            void End(ApiCaller item);
        }
        ...
        public static IApiResult<TResult> CallApi<TArgument, TResult>(string station, string api, TArgument arg)
        {
            ...
            proxy.CallCommand();
            if (proxy.State != ZeroOperatorStateType.Ok)
            {
                proxy._core.CheckStateResult();
            }
            return ApiResultIoc.Ioc.DeserializeObject<TResult>(proxy.Result);
        }
        /// <summary>
        /// 调用远程方法
        /// </summary>
        ...
        public static IApiResult CallApi<TArgument>(string station, string api, TArgument arg)
        {
            ...
            return ApiResultIoc.Ioc.DeserializeObject(proxy.Result);
        }
        ...
        public static TResult Call<TArgument, TResult>(string station, string api, TArgument arg)
        {
            ...
            return JsonHelper.DeserializeObject<TResult>(proxy.Result);
        }
