...
namespace RpcTest
{
    internal class Tester
    {
        ...
        public static void StartTest()
        {
            ...
            //TestFrame("¥ÌŒÛ÷°", ZeroOperatorStateType.FrameInvalid, new byte[1] { 1 });
            //TestFrame("¥ÌŒÛ÷°", ZeroOperatorStateType.FrameInvalid, new byte[1] { 1 });
            //TestFrame("¥ÌŒÛ÷°", ZeroOperatorStateType.FrameInvalid, new byte[1] { 1 }, new byte[1] { 1 });
            //TestFrame("¥ÌŒÛ÷°", ZeroOperatorStateType.FrameInvalid, new byte[] { 1, 1 }, new byte[1] { 0 });
            //TestFrame("¥ÌŒÛ÷°", ZeroOperatorStateType.FrameInvalid, new byte[] { 1, 1 }, new byte[1] { 1 });
            ////TestFrame("¥ÌŒÛ÷°", ZeroOperatorStateType.FrameInvalid, new byte[] { 1, 1 }, new byte[0]);
            //TestFrame("≤Œ ˝¥ÌŒÛ÷°", ZeroOperatorStateType.ArgumentInvalid, new byte[] { 1, 1, (byte)'c', 0 }, new byte[1] { 1 });
            ////◊¥Ã¨∑¢ÀÕ
        ...
        {
            using (var socket = ZSocket.CreateClientSocket(address, ZSocketType.DEALER,ZSocket.CreateIdentity()))
            {
