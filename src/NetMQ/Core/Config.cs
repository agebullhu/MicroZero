/*
    ...
    history:
    2018-05-26 agebull
    exctption from Yqueue.cs line 144 .because m_endPosition so max 256.
    change MessagePipeGranularity value from 256 to 512.for fix 
*/
...
namespace NetMQ.Core
{
    ...
    internal static class Config
    {
        ...
        /// </summary>
        public const int MessagePipeGranularity = 512;
