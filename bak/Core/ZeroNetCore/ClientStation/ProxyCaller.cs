...
namespace Agebull.MicroZero.ZeroApis
{
    ...
    internal class ProxyCaller
    {
        ...
        private void CallApi(ZSocketEx socket)
        {
        ...
        private ZeroResult CallNoFileApi(ZSocketEx socket)
        {
            return Send(socket,
                 CallDescription,
        ...
        private ZeroResult CallByFileApi(ZSocketEx socket)
        {
        ...
        private void CallPlan(ZSocketEx socket, ZeroPlanInfo plan)
        {
        ...
        /// <returns></returns>
        internal ZeroResult Receive(ZSocketEx socket)
        {
        ...
        /// <returns></returns>
        internal ZeroResult Send(ZSocketEx socket, byte[] description, params byte[][] args)
        {
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        private ZeroResult SendToZero(ZSocketEx socket, byte[] description, IEnumerable<byte[]> args)
        {
